/**
* @api {get} /category/list category.R.list
...
*     
* @apiPermission admin
* @apiSampleRequest 192.168.2.3:4000/api/backend/category/list
...
* @apiSuccess (success:200) {Array} list The data of category list.
